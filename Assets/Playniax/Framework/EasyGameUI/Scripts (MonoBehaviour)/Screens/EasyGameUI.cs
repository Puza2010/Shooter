...
namespace Playniax.Ignition
{
    ...
    public class EasyGameUI : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            skills.Add("Homing Missile Level 1", new Skill(missilePrefab, 2.0f, 0, "", "Homing Missile Level 1", missileImage, 1));
            skills.Add("Homing Missile Level 2", new Skill(missilePrefab, 1.5f, 0, "", "Homing Missile Level 2", missileImage, 2));
            skills.Add("Homing Missile Level 3", new Skill(missilePrefab, 1.0f, 0, "", "Homing Missile Level 3", missileImage, 3));
            skills.Add("Homing Missile Level 4", new Skill(missilePrefab, 0.75f, 0, "", "Homing Missile Level 4", missileImage, 4));
            skills.Add("Homing Missile Level 5", new Skill(missilePrefab, 0.5f, 0, "", "Homing Missile Level 5", missileImage, 5));
        }
            ...
            if (player != null)
            {
                ...
                else if (skill.skillName.StartsWith("Homing Missile Level"))
                {
                    ...
                    if (missileSpawner == null)
                    {
                        ...
                        missileSpawner.prefab = missilePrefab;
